            ...
            if(httpMethods != null && httpMethods.Count != 0)
            {
                ...
                if(methodInfo != null)
                {
                    ...
                    parameters = methodInfo.GetParameters()
                        ...
                        .Select(p =>
                        {
                            var paramDescription = GetXmlParamSummary(methodXmlKey, p.Name) ?? "Route parameter";
                    ...
                    // Build the endpoint description
